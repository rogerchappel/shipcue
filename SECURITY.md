...
Replace this section with the supported versions for `shipcue`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `shipcue` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in shipcue.
